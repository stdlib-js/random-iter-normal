...
```javascript
iterator = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-iter-normal@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-iter-normal/tags). For example,

```javascript
iterator = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-iter-normal@v0.2.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var iterator = require( 'path/to/vendor/umd/random-iter-normal/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/random-iter-normal@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/random-iter-normal.svg
[npm-url]: https://npmjs.org/package/@stdlib/random-iter-normal

[test-image]: https://github.com/stdlib-js/random-iter-normal/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/random-iter-normal/actions/workflows/test.yml?query=branch:v0.2.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/random-iter-normal/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/random-iter-normal?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/random-iter-normal.svg
[dependencies-url]: https://david-dm.org/stdlib-js/random-iter-normal/main
...
[deno-url]: https://github.com/stdlib-js/random-iter-normal/tree/deno
[deno-readme]: https://github.com/stdlib-js/random-iter-normal/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/random-iter-normal/tree/umd
[umd-readme]: https://github.com/stdlib-js/random-iter-normal/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/random-iter-normal/tree/esm
[esm-readme]: https://github.com/stdlib-js/random-iter-normal/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/random-iter-normal/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/random-iter-normal/main/LICENSE
